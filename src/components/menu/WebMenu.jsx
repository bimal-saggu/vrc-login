            ...
            case 'Super Admin':
                return (
                  <>
                    ...
                    <li>
                      <a href="/admin/payments"><img src={payments} alt="" /></a>
                      <a href="/admin/payments"><p>Payments</p></a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="/admin/commissions"><img src={home} alt="" /></a>
                      <a href="/admin/commissions"><p>Commissions</p></a>
                    </li>
                    <li>
